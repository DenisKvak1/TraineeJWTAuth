...
- Create Angular project with ng: `ng new traineejwtauth.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`traineejwtauth.client.esproj`).
